...
# -*- coding: utf-8 -*-
#
# ehrcorral documentation build configuration file, created by
...
version = ehrcorral.__version__
# The full version, including alpha/beta/rc tags.
release = ehrcorral.__version__
...
htmlhelp_basename = 'ehrcorraldoc'
...
latex_documents = [
    ('index', 'ehrcorral.tex',
     u'EHRcorral Documentation',
     u'Nikhil Haas', 'manual'),
]
